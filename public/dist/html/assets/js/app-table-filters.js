    ...
    App.tableFilters = function() {
        ...
        $.fn.dataTable.ext.search.push(
            function(settings, searchData, index, rowData, counter) {
                ...
                var filter_notInterested = $('#notInterested').is(':checked');
                ...
                if (!(filter_to_do == false && filter_in_progress == false && filter_in_review == false && filter_done == false && filter_notInterested == false || filter_to_do == true && status[1] == 'to-do' || filter_in_progress == true && status[1] == 'in-progress' || filter_in_review == true && status[1] == 'in-review' || filter_done == true && status[1] == 'done')) { return false; }
