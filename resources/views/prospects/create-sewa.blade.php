...
<div class="be-content">
    <div class="page-head">
      <h2 class="page-head-title">Prospect Rent</h2>
      ...
      <div class="row">
        <div class="col-md-12">
          ...
          <div class="card card-border-color card-border-color-primary">
            ...
            <div class="card-body">
              <form action="{{url('/prospects/sewa/create')}}" method="POST" role="form">
                  @csrf
                ...
                <div class="form-group row">
                  <label class="col-12 col-sm-3 col-form-label text-sm-right" for="KodeProject" >Sales</label>
                  <div class="col-12 col-sm-8 col-lg-6">
                    <select name="KodeSales" class="form-control">
                        <option value="">Pilih</option>
