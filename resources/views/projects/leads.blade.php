                ...
                <div class="card card-table">
                    ...
                    <div class="card-body">
                        <div class="container-fluid">
                            @if (session('filter'))
                                <form action="{{route('project.leads.filter')}}" method="POST">
                                    @csrf
                            ...
                            <form action="{{route('project.leads.move')}}">
                            @if (session('move'))
                                    <div class="row">
                                        <div class="col-12 col-lg-4 table-filters pb-0 ">
                                            <div class="filter-container">
                                                ...
                                                <div class="d-flex justify-content-between">
                                                    <select class="select2 form-control" id="KodeProject" name="KodeProjectNext">
                                    ...
                                    <div class="row">
                                        <div class="col-12 pb-0">
                                            <button class="btn btn-space btn-block btn-secondary btn-big" style="background-color: #2A3F54;color:#fff;"><i class="fa fa-arrows"></i> Move</button>
                                        </div>
                                    </div>
                            @endif
                        </div>
