        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card card-table">
                    ...
                    <form action="{{route('project.leads.move')}}" method="POST" role="form">
                        @csrf
                        <div class="card-body">
                            <div class="container-fluid">
                                <div class="row">
                                    <div class="col-12 col-lg-4 table-filters pb-0 ">
                                        <div class="filter-container">
                                            <label class="control-label">Move to Project :</label>
                                            <div class="d-flex justify-content-between">
                                                <input type="hidden" name="KodeProjectPrev" value="{{$KodeProject}}">
                                                <select class="select2 form-control" id="KodeProject" name="KodeProjectNext" required>
                                                    <option value="">Pilih Project</option>
                                                    @foreach ($project as $item)
                                                    @if ($item->KodeProject != $KodeProject)
                                    ...
                                    <div class="col-12 col-lg-4 table-filters pb-0 ">
                                        <div class="filter-container">
                                            <label class="control-label">Move to Agent :</label>
                                            <div class="d-flex justify-content-between">
                                                <select class="select2 form-control" name="KodeAgentNext" id="KodeAgent">
                                    ...
                                    <div class="col-12 col-lg-4 table-filters pb-0 ">
                                        <div class="filter-container">
                                            ...
                                            <div class="d-flex justify-content-between">
                                                <select class="select2 form-control" name="KodeSalesNext" id="sales">
                                ...
                                <div class="row">
                                    <div class="col-12 pb-0">
                                        <button class="btn btn-space btn-block btn-secondary btn-big" type="submit" style="background-color: #2A3F54;color:#fff;"><i class="fa fa-arrows"></i> Move</button>
                                    </div>
                                </div>
                            </div>
                            <div class="noSwipe">
                                <div class="container-fluid py-2 ">
                                    <table class="table table-striped table-hover be-table-responsive table-responsive " id="table1" border="1px">
                                        ...
                                        <tbody>
                                            ...
                                            @endif
                                                <td><input class="form-check-input " value="{{$item->ProspectID}}" type="checkbox" name="leads[]"><br></td>
        ...
        $('#KodeAgent').change(function(){
            ...
            if(KodeAgent){
                ...
                success:function(res){
                    if(res){
                        $("#sales").empty();
                        $("#sales").append('<option value="">Pilih Sales</option>');
