...
<div class="be-content">
    <div class="page-head mt-5 mt-lg-0">
        <div class="d-flex justify-content-between">
            <h2 class="page-head-title">Prospect Agent</h2>
        </div>
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card card-table">
                    ...
                    <form action="{{url('agent/prospect')}}" method="POST" role="form">
                        @csrf
                        <div class="card-body">
                                            ...
                                            <div class="row">
                                                <div class="col-12 col-lg-4 table-filters pb-0 ">
                                                    <div class="filter-container">
                                                        ...
                                                        <div class="d-flex justify-content-between">
                                                            <input type="hidden" value="{{$KodeAgent}}" name="KodeAgentPrev">
                                                            <select class="select2 form-control" id="KodeAgent" name="KodeAgentNext">
